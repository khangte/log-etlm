...
from ..helpers import align_dlq_columns
from ..schema import DLQ_VALUE_SCHEMA


def build_dlq_clickhouse_df(dlq_kafka_df):
    """DLQ Kafka 레코드를 표준 DLQ 스키마로 변환한다."""
    dlq_parsed = (
        dlq_kafka_df.selectExpr(
