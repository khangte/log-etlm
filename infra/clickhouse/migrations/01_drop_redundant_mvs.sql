...
DROP VIEW IF EXISTS analytics.mv_event_log_latency_1m;

-- mv_event_log_latency_10s:
--   mv_event_log_latency_stage_10s가 e2e_state를 포함하여 제공하므로 중복.
--   Grafana 쿼리는 event_log_latency_stage_10s로 이전.
DROP VIEW IF EXISTS analytics.mv_event_log_latency_10s;
